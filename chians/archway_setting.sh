...
NODE_MONIKER=node
GITURL=https://github.com/archway-network/archway
CHAIN_NAME=archway
CHAIN_BINARY=archwayd
CHAIN_ID=archway-1
SNAP_SHOT_URL=https://snapshots.polkachu.com/snapshots/archway/archway_143937.tar.lz4
SEEDS=""
PERSISTENT_PEERS=""
SYNC_RPC_1=https://archway-rpc.polkachu.com:443
SYNC_RPC_SERVERS="$SYNC_RPC_1,$SYNC_RPC_1"
GENESIS_URL=https://snapshots.polkachu.com/genesis/archway/genesis.json
MINIMUM_GAS_PRICES=""
CHECK=1
